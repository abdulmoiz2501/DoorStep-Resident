                                          ...
                                          children: [
                                            RatingBar.builder(
                                              ...
                                              onRatingUpdate: (rating) {
                                                ...
                                                /*  double newRating =
                                                            ((currentRating + averageRating) / (numberOfRatings + 1));

                                                        updateRating(doc.id, rating, newRating, numberOfRatings);
                                                        print('New rating: $rating');*/
                                              },
                                            ),
                                          ],
...
Future<void> updateRating(String documentId, double newR, double averageRating, int numberOfRatings) async {
  try {
...
//                                                       onRatingUpdate: (rating) {
//                                                         // Handle rating updates
//                                                         double averageRating = double.parse(doc['averageRating'] ?? '0');
//
...
//     String documentId, double newR, double averageRating, int numberOfRatings) async {
//   try {
//     await FirebaseFirestore.instance.collection('service').doc(documentId).update({
//       'rating': newR.toString(),
//       'numberOfRatings': numberOfRatings.toString(),
